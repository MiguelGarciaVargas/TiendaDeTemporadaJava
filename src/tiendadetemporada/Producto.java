...
public class Producto extends javax.swing.JFrame {
    ...
    private void configurarTabla(){
        ...
        modelo.setColumnIdentifiers(new Object[]{"Id producto", "Nombre", "Precio", "Existencias"});
        jTableProductos.setModel(modelo);
    }
    
    private void configuraSpinner(){
        SpinnerNumberModel modeloDecimal = new SpinnerNumberModel(
            0.0,    // valor inicial
            0.0,    // valor mínimo
            1000.0, // valor máximo
            0.1     // paso (incremento)
        );
        jSpinnerPrecio.setModel(modeloDecimal);
    }
    ...
    private void cargarProductos(){
        ...
        String sql = "SELECT * FROM ProductoInfo.Producto;";
        ...
        try {
            ...
            while(rs.next()){
                modelo.addRow(new Object[]{rs.getInt("id_producto"), rs.getString("nombre_producto"), rs.getDouble("precio_producto"), rs.getInt("existencias")});
            }
            jTextFieldNombre.setText("");
            jSpinnerPrecio.setValue(0);
            jSpinnerExistencias.setValue(0);
            conexion.close();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error al cargar los datos" + e.getMessage(), "Error de query", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        jButtonEliminar.setBackground(jLabel3.getForeground());
        ...
        jButtonAgregar.setBackground(jLabel3.getForeground());
        ...
        jButtonEditar.setBackground(jLabel3.getForeground());
